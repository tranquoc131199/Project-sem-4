                    ...
                    <ul class="header-btns">
                        <li class="header-account dropdown default-dropdown">
                            <div class="dropdown-toggle" role="button" data-toggle="dropdown" aria-expanded="true">
                                ...
                                <a href="/Customer/Login" class="text-uppercase small-font">Đăng nhập</a> / <a href="/Customer/Register" class="text-uppercase small-font">Đăng ký</a>
                            <ul class="custom-menu">
                                <li><a href="/Customer"><i class="fa fa-user-o"></i> Cá nhân</a></li>
                                <li><a href="/Customer/Wishlist"><i class="fa fa-heart-o"></i> Yêu thích</a></li>
                                <li><a href="/Customer/OrderList"><i class="fa fa-gift"></i> Đơn hàng</a></li>
                            </ul>
                        </li>

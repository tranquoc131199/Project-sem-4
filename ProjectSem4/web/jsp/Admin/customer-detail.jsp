<%-- 
    ...
    Created on : Jun 6, 2019, 5:20:54 PM
    Author     : Thang Pham
--%>
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/admin/customer.html" class="breadcrumb-link">Khách hàng</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="user-avatar text-center d-block">
                                <img src="${pageContext.request.contextPath}/views/backend/uploads/images/Customers/${customer.customerAvatar}" alt="User Avatar" class="rounded-circle user-avatar-xxl">
                            </div>
                            ...
                            <div class="text-center">
                                <c:if test="${customer.customerStatus == 1}">
                                    <a href="${pageContext.request.contextPath}/admin/customer/disable.html?customerId=${customer.customerId}" class="btn btn-sm btn-secondary"><i class="fas fa-lock"></i> Khoá tài khoản</a>
                                </c:if>
                                <c:if test="${customer.customerStatus == 0}">
                                    <a href="${pageContext.request.contextPath}/admin/customer/enable.html?customerId=${customer.customerId}" class="btn btn-sm btn-success"><i class="fas fa-lock-open"></i> Mở khoá tài khoản</a>
                                </c:if>
                            </div>
                        </div>
                ...
                <div class="col-xl-9 col-lg-9 col-md-7 col-sm-12 col-12">
                    <div class="influence-profile-content pills-regular">
                        <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-product-rate-tab" data-toggle="pill" href="#pills-product-rate" role="tab" aria-controls="pills-product-rate" aria-selected="true">Bình luận/Đánh giá sản phẩm</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-news-comment-tab" data-toggle="pill" href="#pills-news-comment" role="tab" aria-controls="pills-news-comment" aria-selected="false">Bình luận tin tức</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-promotion-comment-tab" data-toggle="pill" href="#pills-promotion-comment" role="tab" aria-controls="pills-promotion-comment" aria-selected="false">Bình luận chương trình KM</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-product-rate" role="tabpanel" aria-labelledby="pills-product-rate-tab">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <c:if test="${cmt.productCommentStatus == 1}">
                                                                            <a href="${pageContext.request.contextPath}/admin/customer/disable-product-comment.html?productCommentId=${cmt.productCommentId}&customerId=${customer.customerId}" class="btn btn-sm btn-secondary"><i class="fas fa-lock"></i> Khoá</a>
                                                                        </c:if>
                                                                        <c:if test="${cmt.productCommentStatus == 0}">
                                                                            <a href="${pageContext.request.contextPath}/admin/customer/enable-product-comment.html?productCommentId=${cmt.productCommentId}&customerId=${customer.customerId}" class="btn btn-sm btn-success"><i class="fas fa-lock-open"></i> Mở khoá</a>
                                                                        </c:if>
                                                                    </td>
                                                                </tr>
                                                            </c:forEach>
                                ...
                                <div class="tab-pane fade" id="pills-news-comment" role="tabpanel" aria-labelledby="pills-news-comment-tab">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            <c:if test="${not empty newComments}">
                                                                <c:forEach items="${newComments}" var="ncmt">
                                                                    <tr>
                                                                        <td>${ncmt.newId.newTitle}</td>
                                                                        <td>
                                                                            ${ncmt.newCommentContent}
                                                                        </td>
                                                                        <td><fmt:formatDate value="${ncmt.newCommentTime}" /></td>
                                                                        <td>
                                                                            <c:if test="${ncmt.newCommentStatus == 1}">
                                                                                <a href="${pageContext.request.contextPath}/admin/customer/disable-news-comment.html?newCommentId=${ncmt.newCommentId}&customerId=${customer.customerId}" class="btn btn-sm btn-secondary"><i class="fas fa-lock"></i> Khoá</a>
                                                                            </c:if>
                                                                            <c:if test="${ncmt.newCommentStatus == 0}">
                                                                                <a href="${pageContext.request.contextPath}/admin/customer/enable-news-comment.html?newCommentId=${ncmt.newCommentId}&customerId=${customer.customerId}" class="btn btn-sm btn-success"><i class="fas fa-lock-open"></i> Mở khoá</a>
                                                                            </c:if>
                                                                        </td>
                                                                    </tr>
                                                                </c:forEach>
                                ...
                                <div class="tab-pane fade" id="pills-promotion-comment" role="tabpanel" aria-labelledby="pills-promotion-comment-tab">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                        <c:if test="${not empty promotionComments}">
                                                            <c:forEach items="${promotionComments}" var="pcmt">
                                                                <tr>
                                                                    <td>${pcmt.promotionId.promotionTitle}</td>
                                                                    <td>${pcmt.promotionCommentContent}</td>
                                                                    <td><fmt:formatDate value="${pcmt.promotionCommentTime}" /></td>
                                                                    <td>
                                                                        <c:if test="${promotionCommentStatus == 1}">
                                                                            <a href="${pageContext.request.contextPath}/admin/customer/disable-news-comment.html?newCommentId=${ncmt.newCommentId}&customerId=${customer.customerId}" class="btn btn-sm btn-secondary"><i class="fas fa-lock"></i> Khoá</a>
                                                                        </c:if>
                                                                        <c:if test="${promotionCommentStatus == 0}">
                                                                            <a href="${pageContext.request.contextPath}/admin/customer/enable-news-comment.html?newCommentId=${ncmt.newCommentId}&customerId=${customer.customerId}" class="btn btn-sm btn-success"><i class="fas fa-lock-open"></i> Mở khoá</a>
                                                                        </c:if>
                                                                    </td>
                                                                </tr>

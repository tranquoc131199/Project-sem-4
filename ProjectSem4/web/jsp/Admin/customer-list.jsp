<%-- 
    ...
    Created on : Jun 6, 2019, 5:01:25 PM
    Author     : Thang Pham
--%>
                                                ...
                                                <div class="row">
                                                    <div class="col col-md-2 user-avatar float-xl-left pr-4 float-none text-center">
                                                        <a href="${pageContext.request.contextPath}/admin/customer/detail.htm?customerId=${c.customerId}">
                                                            <img src="${pageContext.request.contextPath}/views/backend/uploads/images/Customers/${c.customerAvatar}" alt="User Avatar" class="rounded-circle user-avatar-xl">
                                                        </a>

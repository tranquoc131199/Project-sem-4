<%-- 
    Document   : payment-insert
    Created on : Jun 6, 2019, 5:26:06 PM
    Author     : QuanKoiNA
--%>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="${pageContext.request.contextPath}/admin/payment/do-insert.htm">
                                    <div class="form-group">
                                        <label for="paymentMethodName" class="col-form-label">Tên phương thức thanh toán:</label>
                                        <input name="paymentMethodName" id="paymentMethodName" maxlength="250" type="text" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <label for="paymentMethodDescription" class="col-form-label">Mô tả:</label>
                                        <input name="paymentMethodDescription" id="paymentMethodDescription" type="text" class="form-control" />
                                    </div>
                                    <div class="form-group">

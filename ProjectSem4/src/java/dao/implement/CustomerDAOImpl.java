...
public class CustomerDAOImpl implements CustomerDAO {
    ...
    public Customers getCustomerById(Integer customerId) {
        ...
        try {
            ...
            System.out.println("dao.impl.CustomerDAOImpl.getCustomerById()");
            e.getMessage();
            session.getTransaction().rollback();
        } finally {
            session.close();
    ...
    public Boolean removeWishlist(Customers customer, Products product) {
        ...
        try {
            ...
            System.out.println("dao.impl.CustomerDAOImpl.removeWishlist()");
            e.getMessage();
            session.getTransaction().rollback();
        } finally {
            session.close();
    ...
    public Boolean addToWishlist(Wishlists wishlist) {
        ...
        try {
            ...
            System.out.println("dao.impl.CustomerDAOImpl.addToWishlist()");
            e.getMessage();
            session.getTransaction().rollback();
        } finally {
            session.close();

...
public class paging {
    ...
    // hàm khởi tạo - truyền vào các tham số: trang hiện tại, tổng số trang, số bản ghi trên 1 trang, trang hiện tại và trang đầu tiên
    ...
    public String generateHtmlFrontend() {
        ...
        if (totalRecords > limitRecords) {
            ...
            htmlGenerate += "<li><span class='text-uppercase'>Trang:</span></li>";

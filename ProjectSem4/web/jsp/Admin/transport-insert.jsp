<%-- 
    Document   : transport-insert
    Created on : Jun 6, 2019, 5:24:36 PM
    Author     : QuanKoiNA
--%>
        ...
        <div class="container-fluid dashboard-content ">
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Tạo mới phương thức vận chuyển</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="ecommerce-widget">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h3 class="card-header"><b>Tạo mới phương thức vận chuyển</b></h3>
                            <div class="card-body">
                                ...
                                <form method="POST" action="${pageContext.request.contextPath}/admin/transport/do-insert.htm">
                                    <div class="form-group">
                                        <label for="transportName" class="col-form-label">Tên phương thức vận chuyển:</label>
                                        <input id="transportName" maxlength="250" name="transportName" type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="transportDescription" class="col-form-label">Mô tả:</label>
                                        <input id="transportDescription" name="transportDescription" type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="transportPrice" class="col-form-label">Mức giá:</label>
                                        <input id="transportPrice" name="transportPrice" type="number" min="10000" step="1000" class="form-control">
                                    </div>
                                    <div class="form-group">
